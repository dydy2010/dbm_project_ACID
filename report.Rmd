...
```
```{r ZurichAverageVolumeDistrictMap, fig.cap="Stress Index Classification", fig.align='center', out.width='80%', fig.pos='H'}
knitr::include_graphics("materials_for_report_later/FinalScreenShots/ZurichAverageVolumeDistrictMap.jpeg")
```
```{r ZurichNumberOfDistrictsMap, fig.cap="Stress Index Classification", fig.align='center', out.width='80%', fig.pos='H'}
