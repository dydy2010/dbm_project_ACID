...
```
```{r ZurichAverageVolumeDistrictMap, fig.cap="Average Volume per District", fig.align='center', out.width='80%', fig.pos='H'}
knitr::include_graphics("materials_for_report_later/FinalScreenShots/ZurichAverageVolumeDistrictMap.jpeg")
```
```{r ZurichNumberOfDistrictsMap, fig.cap="Number of Bottlenecks per District", fig.align='center', out.width='80%', fig.pos='H'}
