...
knitr::include_graphics("materials_for_report_later/PopulationVSTrafficGrowth.jpeg")
```
...
### District Pressure Map (KPI 1)<br>
This table groups districts by their "Stress Index" classification (Commuter Pressure vs. Residential Pressure vs Insufficient data).<br>

```{r stress-index-classification, fig.cap="Stress Index Classification", fig.align='center', out.width='80%', fig.pos='H'}
knitr::include_graphics("materials_for_report_later/StressIndexClassificationPressureZones.png")
```

- **Key Insight:** Identifies specific districts that may face high commuter inflows (Traffic Growth > Population Growth) and let our client know, which area they should focus on implementing urban design and infraestructure measures.<br>

- **Decision Recommendation for Client:**  Direct investments toward _commuter-pressure_ zones requiring road capacity expansion and traffic management. In _residential-pressure_ districts, improve public transit and other mobility options such as improved cycle-friendly roads to sustain traffic despite demographic growth.<br>
...
knitr::include_graphics("materials_for_report_later/Top10BottlenecksAndPeakHours.png")
```
...
knitr::include_graphics("materials_for_report_later/KP3DirectionClassificationStrongCorridorDependency.png")
```
