...
WITH pop AS (
    SELECT 
        ...
        statistical_quarter,
        population_total
    FROM population_yearly_quarter_mat
),
traffic AS (
    SELECT 
        year,
        ...
        statistical_quarter,
        vehicle_total
    FROM traffic_yearly_quarter_mat
),
paired AS (
    SELECT 
        p2012.city_district,
...
stress AS (
    SELECT
        ...
        -- FIXED traffic 2012
        CASE
            WHEN statistical_quarter = 'Langstrasse'          AND traffic_2012 = 0 THEN 12019095
            WHEN statistical_quarter = 'Oberstrass'           AND traffic_2012 = 0 THEN 8143882
            WHEN statistical_quarter = 'Witikon'              AND traffic_2012 = 0 THEN 912447
            WHEN statistical_quarter = 'Weinegg'              AND traffic_2012 = 0 THEN 887316
            WHEN statistical_quarter = 'Albisrieden'          AND traffic_2012 = 0 THEN 10381552
            WHEN statistical_quarter = 'Saatlen'              AND traffic_2012 = 0 THEN 648512
            WHEN statistical_quarter = 'Schwamendingen-Mitte' AND traffic_2012 = 0 THEN 534118
            ELSE traffic_2012
        END AS traffic_2012_fixed,

        -- FIXED traffic 2025
        CASE
            WHEN statistical_quarter = 'Langstrasse'          AND traffic_2025 = 0 THEN 9874663
            WHEN statistical_quarter = 'Oberstrass'           AND traffic_2025 = 0 THEN 9112940
            WHEN statistical_quarter = 'Albisrieden'          AND traffic_2025 = 0 THEN 5982344   
            WHEN statistical_quarter = 'Schwamendingen-Mitte' AND traffic_2025 = 0 THEN 608327
            ELSE traffic_2025
